...
# 	- Start at the root of a tree and visit every node from one level of the tree to the next.
# 	- So instead of going up and down the tree, we visit every node on a level before 
